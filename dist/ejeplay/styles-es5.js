(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["styles"], {
  ...
  function node_modulesCssLoaderDistCjsJsNode_modulesPostcssLoaderSrcIndexJsNode_modulesSassLoaderDistCjsJsSrcStylesScss(module, exports, __webpack_require__) {
    ...
    exports.push([module.i, ".pago {\n  width: 30%;\n  height: 45px;\n  border-radius: 5px;\n  background-color: #364d6a;\n  border: solid;\n  border-color: #364d6a;\n  color: #fff;\n  transition: 600ms;\n}\n\n.pago:hover {\n  border: solid;\n  border-color: #364d6a;\n  background-color: #fff;\n  color: #364d6a;\n  transition: 600ms;\n}\n\n.btn-whatsapp {\n  cursor: pointer;\n  display: block;\n  width: 70px;\n  height: 70px;\n  color: #fff;\n  position: fixed;\n  right: 20px;\n  bottom: 50px;\n  border-radius: 50%;\n  line-height: 80px;\n  text-align: center;\n  z-index: 999;\n}\n\n.btn-whatsapp:hover {\n  transform: scale(1.1);\n}", "", {
      "version": 3,
      "sources": ["/Users/Fernando/Desktop/proyectos/Angular/ejeplay 7 enero 22/src/styles.scss", "styles.scss"],
      "names": [],
      "mappings": "AAAA;EACI,UAAA;EACA,YAAA;EACA,kBAAA;EACA,yBAAA;EACA,aAAA;EACA,qBAAA;EACA,WAAA;EACA,iBAAA;ACCJ;;ADEA;EACI,aAAA;EACA,qBAAA;EACA,sBAAA;EACA,cAAA;EACA,iBAAA;ACCJ;;ADEA;EACI,eAAA;EACA,cAAA;EACA,WAAA;EACA,YAAA;EACA,WAAA;EACA,eAAA;EACA,WAAA;EACA,YAAA;EACA,kBAAA;EACA,iBAAA;EACA,kBAAA;EACA,YAAA;ACCJ;;ADEE;EACE,qBAAA;ACCJ",
      "file": "styles.scss",
      "sourcesContent": [".pago {\n    width: 30%;\n    height: 45px;\n    border-radius: 5px;\n    background-color: #364d6a;\n    border: solid;\n    border-color: #364d6a;\n    color: #fff;\n    transition: 600ms;\n}\n\n.pago:hover {\n    border: solid;\n    border-color: #364d6a;\n    background-color: #fff;\n    color: #364d6a;\n    transition: 600ms;\n}\n\n.btn-whatsapp {\n    cursor: pointer;\n    display:block;\n    width:70px;\n    height:70px;\n    color:#fff;\n    position: fixed;\n    right:20px;\n    bottom:50px;\n    border-radius:50%;\n    line-height:80px;\n    text-align:center;\n    z-index:999;\n  }\n  \n  .btn-whatsapp:hover{\n    transform: scale(1.1);\n  }", ".pago {\n  width: 30%;\n  height: 45px;\n  border-radius: 5px;\n  background-color: #364d6a;\n  border: solid;\n  border-color: #364d6a;\n  color: #fff;\n  transition: 600ms;\n}\n\n.pago:hover {\n  border: solid;\n  border-color: #364d6a;\n  background-color: #fff;\n  color: #364d6a;\n  transition: 600ms;\n}\n\n.btn-whatsapp {\n  cursor: pointer;\n  display: block;\n  width: 70px;\n  height: 70px;\n  color: #fff;\n  position: fixed;\n  right: 20px;\n  bottom: 50px;\n  border-radius: 50%;\n  line-height: 80px;\n  text-align: center;\n  z-index: 999;\n}\n\n.btn-whatsapp:hover {\n  transform: scale(1.1);\n}"]
    }]); // Exports
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! /Users/Fernando/Desktop/proyectos/Angular/ejeplay 7 enero 22/src/styles.scss */
    "./src/styles.scss");
    /***/
  }
}, [[3, "runtime"]]]);
