...
@Component({
  selector: 'app-detalleps5',
  templateUrl: './detalleps5.component.html',
  styleUrls: ['./detalleps5.component.scss']
})
export class Detalleps5Component implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.productoSvc.loadGamePs5ById(id)
                    .subscribe(res => {
                      this.game = res;
                      ...
                      this.productoSvc.loadGamesByCategoryPs5(this.categoria)
                                      .subscribe(cat => {
